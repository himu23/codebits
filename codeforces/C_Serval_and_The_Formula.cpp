...
void solve() {
    ...
    //we have to construct k bitwise;
    // ll ans=0;
    ...
    //     // if(flag1 && flag2){
    //     //     ans+=binpow(2,i);
    //     //     if(carry1<carry2) carry1++;
    //     //     else carry2++;
    //     //     continue;
    //     // }
    //     // if(!flag1 && carry1>0){flag1=true; carry1--;}
    //     // else if(!flag2 && carry2>0){flag2=true; carry2--;}
    //     // if(flag1 && flag2){
    //     //     ans+=binpow(2,i);
    //     //     if(carry1<carry2) carry1++;
    //     //     else carry2++;
    ...
    //         bk=1;
    //         s1++,s2++;
    //         if(s1%2==1 && s2%2==1){cout<<-1<<endl;return;}
    //     }
    //     carry1=s1/2;
    //     carry2=s2/2;
    // }
