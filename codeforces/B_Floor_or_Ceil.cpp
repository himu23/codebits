...
//     ll tm=binpow(2,m);
//     ll ans=x/tn;
//     // vector<ll> temp=getbits(ans);
//     ll temp=0;
//     if(x!=0) temp=__builtin_ctz(x);
//     ans/=tm;
//     if(temp<=m && ans!=0) ans++;
//     ll ans1=(x/tm)/tn;
//     if(n==0) ans1=ans;
...
//given constraints vs real constraints
//only 30-40 operations needed so n,m<=1e9 is useless, 0 will stay 0
void solve(){
    ll x,n,m; cin>>x>>n>>m;
    ll minn=x;
    ll maxx=x;
