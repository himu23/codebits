...
void solve() {
    ...
    if(maxx>k+cnt){cout<<-1<<endl;return;}
    cnt=k;
    int l=0,r=0;
    vector<int> ans;
    while(l<n && r<m){
        if(a[l]==0){ans.pb(0);cnt++;l++;}
        else if(b[r]==0){ans.pb(0);cnt++;r++;}
        else if(a[l]<=cnt){ans.pb(a[l]);l++;}
        else if(b[r]<=cnt){ans.pb(b[r]);r++;}
