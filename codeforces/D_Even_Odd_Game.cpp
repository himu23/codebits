...
void solve() {
    ...
    //mathematical formula or i have to simulate the game
    sort(ve.begin(),ve.end(),greater<ll>());
    sort(vo.begin(),vo.end(),greater<ll>());
    ll ne=ve.size(),no=vo.size();
    ll cnt=0;
    ll ie=0,io=0;
    ll e=0,o=0;
    while(ie<ne || io<no){
    ...
    if(e==o) cout<<"Tie"<<endl;
    else if(e>o) cout<<"Alice"<<endl;
    else cout<<"Bob"<<endl;
}
