...
void solve() {
    ...
    // int temp=k*(k+1)/2;
    // int ans=0;
    // if(temp==n)cout<<k<<endl;
    // else if(temp>n){
    //     int cur=(sqrt(1+8*n)-1)/2;
    //     int t1=(cur*(cur+1))/2;
    //     if(t1==n) cout<<cur<<endl;
